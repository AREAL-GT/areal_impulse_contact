...
# Contact model example: 1d bouncing body with multiple contact points
...
e1 = 0.5
e2 = 1
sp_1d_cont =  contact.ImpulseContact(cont_points2, m, I, e=e1, 
                                     debug_ctl=contact_debug_ctl)

# Example 1d system dynamics function
def sysdyn_1d_mp(t, x):
...
output_ctl1 = { # Output file control
    ...
    'filename': 'ex_1d_mp_bounce.csv', # Name for output file
...
# Run the simulation
sim_test = simulator.Simulator(tspan, x0, sysdyn_1d_mp, timestep=timestep,
